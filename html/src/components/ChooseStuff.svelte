...
<div class="container">
  ...
  <div class="input flex flex-col space-y-1">
    {#each ["overview", "employees", "hire", "stash", "money"] as section}
      ...
      >
        {#if section === "overview"}
          <i class="fa-solid fa-circle-info text-xl text-blue-500" />
          <span
            ...
            >Overview ‎ ‎ ‎ ‎ ‎ ‎ ‎ ‎ <!-- Added så det står samme sted -->
          </span>
        {:else if section === "employees"}
          <i class="fa-solid fa-users text-xl text-blue-500" />
          <span
            class="absolute top-0 left-0 w-full h-full flex items-center justify-center opacity-100 group-hover:opacity-100 transition duration-300 bg-opacity-70 group-hover:bg-opacity-100"
            >Employees</span
          >
        {:else if section === "hire"}
          <i class="fa-solid fa-hand-holding text-xl text-blue-500" />
          <span
            class="absolute top-0 left-0 w-full h-full flex items-center justify-center opacity-100 group-hover:opacity-100 transition duration-300 bg-opacity-70 group-hover:bg-opacity-100"
            >Hire Person</span
          >
        {:else if section === "stash"}
          <i class="fa-solid fa-circle-user text-xl text-blue-500" />
          <span
            class="absolute top-0 left-0 w-full h-full flex items-center justify-center opacity-100 group-hover:opacity-100 transition duration-300 bg-opacity-70 group-hover:bg-opacity-100"
            >Personal ‎ ‎ ‎ ‎ ‎ ‎</span
          >
        {:else if section === "money"}
          <i class="fa-solid fa-money-check-dollar text-xl text-blue-500" />
          <span
            class="absolute top-0 left-0 w-full h-full flex items-center justify-center opacity-100 group-hover:opacity-100 transition duration-300 bg-opacity-70 group-hover:bg-opacity-100"
            >Money‎ ‎ ‎ ‎ ‎ ‎‎ ‎ ‎‎ ‎ ‎</span
          >
      ...
      {#each $users as { name, empSource, gradeLabel, online, isboss }, index (gradeLabel)}
        <div class="mb-4 py-6 bg-neutral-700 p-6 rounded-lg shadow-lg">
          <div class="grid grid-cols-7 gap-1">
            ...
            <h3 class="text-base text-white">Rank: {gradeLabel}.</h3>
            <h3 class="text-base text-white">Manager: {isboss}.</h3>
            ...
            <div class="col-span-20 flex items-center justify-center space-x-1">
              <span class="text-green-500">In Town</span>
              <span class="text-gray-400">|</span>
              <span class="text-red-500">Not In Town</span>
            </div>
              ...
              >
                ...
                rounded transition duration-300 ease-in-out hover:bg-green-500"
                  >
                    ...
                    Change Rank To {selectedGrade.navn}
                  </button>
